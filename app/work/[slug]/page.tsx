...
const WorkDetailPage = () => {
  ...
  useEffect(() => {
    const fetchWorkDetail = async () => {
      try {
        const response = await fetch(`${BASE_API}/api/works?populate=*`, {
          headers: {
        ...
        if (data.data && data.data.length > 0) {
          ...
          if (workData) {
            ...
            setError("No work found with this slug");
          }
        } else {
    ...
    return (
      <div className="min-h-screen bg-[rgb(12,30,49)] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-primary-white text-xl">
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-[rgba(255,255,255,0.05)] p-6 rounded-xl backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-sm text-gray-400 uppercase">Service</h3>
